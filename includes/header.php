...
<head>
	<link rel="icon" type="images/svg" href="images/logo1.jpg">
	<title>Faith University College FUC</title>
	<meta charset="utf-8">
	...
	<div class="bg-top navbar-light d-flex flex-column-reverse">
		<div class="container py-3">
			<div class="row no-gutters d-flex align-items-center align-items-stretch">
				<a href="index.php" class="col-md-4 d-flex align-items-center py-4">
					<img style="margin-top: -33px;" src="images/logo3.png" alt="">
				</a>
				<div class="col-lg-8 d-block">
					<div class="row d-flex">
						<div class="col-md d-flex topper align-items-center align-items-stretch py-md-4">
							...
							<div class="text">
								<span>Email</span>
								<span>faithuniversity@gmail.com</span>
							</div>
						</div>
						<div class="col-md d-flex topper align-items-center align-items-stretch py-md-4">
							<div class="icon d-flex justify-content-center align-items-center"><span
		...
		<div class="top-social-menu py-2 bg-light">
			<div class="container">
				<div class="row">
					<div class="col">
						<p class="social mb-0">Connect with us via
					...
					<div class="col text-right">
						<a href="donate.php" class="btn py-1 px-1 btn-primary">Apply Now</a>
					</div>
				</div>
			</div>
		</div>
