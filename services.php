		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-10 text-center heading-section heading-section-white ftco-animate">
					<h2 style="text-align: center; text-decoration: underline; color: #8B0000; ">ACADEMIC PROGRAMS</h2>
					<h2 class="mb-0" style="color: black;" >Diploma/Certificate/Associate Degree/ B.sc/ BBA</h2>
					<h2 class="mb-0">100% Approved And Accredited By The National Commission On Higher Education.</h2>
				</div>
			</div>
		</div>
	</section>
